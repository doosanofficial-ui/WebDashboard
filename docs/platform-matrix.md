...
- [x] Background location 서비스 구현(iOS Significant-Change + Android FGS) — iOS: 구현 완료 / Android: FGS 스캐폴드 완료 — 가이드: [`docs/android-fgs-bg-location.md`](android-fgs-bg-location.md) — 검증 절차: [`docs/reports/ios-bg-30min-template.md`](reports/ios-bg-30min-template.md)
