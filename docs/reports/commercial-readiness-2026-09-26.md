...
- GPS permission-denied and location-unavailable paths are recorded as stable
  `gps_permission_denied`/`gps_unavailable` system events.
...
| Native Reliability | PASS, Core + native app + Linux/Windows contracts | PR #23 run `36260414716`; native-app job generated XcodeGen project and built the iOS target |
