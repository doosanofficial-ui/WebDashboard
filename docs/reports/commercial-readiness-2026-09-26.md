...
| Native Reliability | PASS, Core + native app + Linux/Windows contracts | PR #23 run `36259262945`; native-app job generated XcodeGen project and built the iOS target |
