...
- Versioned dashboard pages with persisted portrait/landscape orientation, grid-based
  ...
  inspector for signal binding, labels, units, ranges, and thresholds.
...
then build for the connected device. The current native development version is 0.6.0 while
